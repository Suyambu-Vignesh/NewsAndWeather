...
import com.svk.newsapiclient.databinding.FragmentNewsBinding
...
class NewsFragment : Fragment() {
    ...
    private fun viewNewsList() {
        ...
        viewModel.newsHeadLines.observe(viewLifecycleOwner,{response->
            when(response){
               is com.svk.newsapiclient.data.util.Resource.Success->{
                ...
                is com.svk.newsapiclient.data.util.Resource.Error->{
                   hideProgressBar()
                ...
                is com.svk.newsapiclient.data.util.Resource.Loading->{
                    showProgressBar()
                }
